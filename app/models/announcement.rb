...
class Announcement < ApplicationRecord
  ...
  accepts_nested_attributes_for :announcement_links, reject_if: proc { |attrs| attrs['url'].blank? && attrs['text'].blank? }, allow_destroy: true
  default_scope { includes(:announcement_links).order(order: :desc) }
